/**
 * Open the "Add Task" modal in the board
...
/**
 * Close the "Add Task" modal in the board
 */
...
/**
 * Reset the status and save it to localStorage
 * @param {string} status - The status of the task
 */
...
/**
 * Return the HTML for the "Add Task" modal in the board
            ...
            <div class="flex-row task-content in-board-task-cnt">
                <div class="task-left-cont">
                    <div class="task-width">
                        ...
                        <input id="taskTitle" class="task-width task-form-font task-input" type="text" placeholder="Enter a title" maxlength="35" required>
                ...
                <div class="task-right-cont" id="taskRightCont">
                    ...
                    <div>
                        ...
                        <div class="flex-row task-btn-cont">
                            ...
                            <div onclick="changeUrgency('mid')" onmouseover="hoverBtn(true, 'img-mid')" onmouseout="hoverBtn(false, 'img-mid')" class="task-urgent-btn bg-white" id="mid">
                                <span>Medium</span>
